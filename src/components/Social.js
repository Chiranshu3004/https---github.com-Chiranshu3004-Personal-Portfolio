...
const Social = () => {
  return (
    ...
    <div>
      <a href="https://drive.google.com/file/d/1TOMr5NZBCMtg5kofm1ftPvFw8sv1scSa/view?usp=drive_link" className='btn' target="_blank" rel="noopener noreferrer">Download CV</a>
    </div>
    </>
  )
}
